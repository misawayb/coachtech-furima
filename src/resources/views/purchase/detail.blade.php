...
<div class="purchase-page">
    <div class="purchase-group">
        <form class="purchase-form" action="{{ route('purchase.payment', $item->id ) }}" method="post">
            @csrf
            <div class="purchase-fields">
                ...
                <div class="purchase-field">
                    ...
                    <select class="select-payment_method" name="payment_method" id="payment_method">
                        <option value="" hidden disabled selected>選択してください</option>
                        @foreach( $payment_methods as $payment_method )
                        <option value="{{ $payment_method->value }}" {{ ($selected_payment['payment_method'] ?? '') == $payment_method->value ? 'selected' : '' }}>{{ $payment_method->value}}</option>
                        @endforeach
                    </select>
    ...
    <div class="summary-field">
        <div class="summary-items">
            ...
            <div class="summary-item">
                ...
                <span class="summary-content" id="payment-display">{{ $selected_payment['payment_method'] ?? '' }}</span>
            </div>
        </div>
        <button class="red-btn" type="submit">購入する</button>
    </div>
    </form>
</div>
<script>
